...
!function(e,t,n){"use strict";t=t&&t.hasOwnProperty("default")?t.default:t,n=n&&n.hasOwnProperty("default")?n.default:n;var o="undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{};class r extends Error{constructor(e){super(e),this.message=e}}class i extends r{constructor(e,t,n,o){if(!t||!["Server","Client"].includes(t))throw new TypeError("Error constructing PalindromConnectionError, `side` parameter is required and can either be 'Server' or 'Client'");super(e),this.side=t,this.message=`${t} error\n\t${e.replace(/\n/g,"\n\t")}`,this.url=n,this.connectionType=o}}const s="Client";function a(e,t,n,o){let r,a;this.start=function(){r||(r=setTimeout(()=>{this.notifySend(),e()},n))},this.notifySend=function(){clearTimeout(r),r=null,a||(a=setTimeout(()=>{a=null,t(new i("Timeout has passed and response hasn't arrived",s,this.remoteUrl,"Unknown"))},o))},this.notifyReceive=function(){clearTimeout(a),a=null,this.start()},this.stop=()=>{clearTimeout(r),r=null,clearTimeout(a),a=null}}function h(){this.start=this.stop=this.notifySend=this.notifyReceive=()=>{}}const c="undefined"!=typeof globalThis&&globalThis||"undefined"!=typeof window&&window||void 0!==o&&o,p="Client",l="Server";function u(e){return e.replace(/^http/i,"ws")}class d{constructor(e,t,n,o,r,i,s,c,p){if(this.palindrom=e,"undefined"!=typeof window&&window.location?this.remoteUrl=new URL(t,window.location.href):this.remoteUrl=new URL(t),o&&(this.onReceive=o),r&&(this.onSend=r),i&&(this.onConnectionError=i),c&&(this.onStateChange=c),s&&(this.onSocketOpened=s),Object.defineProperty(this,"useWebSocket",{get:function(){return n},set:e=>(n=e,0==e?this._ws&&(this._ws.onclose=function(){this._ws=null},this._ws.close()):this.wsUrl||(this.wsUrl=u(this.remoteUrl.href)),n)}),p){const e=1e3*p;this.heartbeat=new a(()=>{this.send([])},this._handleConnectionError.bind(this),e,e)}else this.heartbeat=new h}async _establish(e=null){this.heartbeat.stop();const t=e?await this._fetch("PATCH",this.remoteUrl.href+"/reconnect","application/json",JSON.stringify(e)):await this._fetch("GET",this.remoteUrl.href,"application/json",null);return this.useWebSocket&&this.webSocketUpgrade(this.onSocketOpened),this.heartbeat.start(),t}_handleConnectionError(e){this.heartbeat.stop(),this.palindrom.reconnector.triggerReconnection(),this.onConnectionError(e)}_handleFatalError(e){this.heartbeat.stop(),this.palindrom.reconnector.stopReconnecting(),this.onConnectionError(e)}_notifyReceive(){this.heartbeat.notifyReceive(),this.onReceive(...arguments)}async send(e){this.heartbeat.notifySend();const t=JSON.stringify(e);if(this.useWebSocket&&this._ws&&1===this._ws.readyState)this._ws.send(t),this.onSend(t,this._ws.url,"WS");else{const e=this.remoteUrl.href,n="PATCH",o=await this._fetch(n,e,"application/json-patch+json",t);this._notifyReceive(o,e,n)}return this}onReceive(){}onSend(){}onStateChange(){}upgrade(e){}webSocketUpgrade(e){this.wsUrl=u(this.remoteUrl.href);const t=this.wsUrl;this.closeConnection();let o=c.WebSocket||n;o=o.w3cwebsocket||o,this._ws=new o(t),this._ws.onopen=n=>{this.onStateChange(this._ws.readyState,t),e&&e(n)},this._ws.onmessage=e=>{try{var t=JSON.parse(e.data)}catch(t){return void this._handleFatalError(new i(e.data,l,this._ws.url,"WS"))}this._notifyReceive(t,this._ws.url,"WS")},this._ws.onerror=e=>{if(this.onStateChange(this._ws.readyState,t,e.data),!this.useWebSocket)return;const n=["WebSocket connection could not be made","readyState: "+this._ws.readyState].join("\n");this._handleFatalError(new i(n,p,t,"WS"))},this._ws.onclose=e=>{this.onStateChange(this._ws.readyState,t,null,e.code,e.reason);const n=["WebSocket connection closed unexpectedly.","reason: "+e.reason,"readyState: "+this._ws.readyState,"stateCode: "+e.code].join("\n");e.reason?this._handleFatalError(new i(n,l,t,"WS")):e.wasClean||this._handleConnectionError(new i(n,l,t,"WS"))}}closeConnection(){this._ws&&(this._ws.onclose=()=>{},this._ws.close(),this._ws=null)}stop(){this.closeConnection(),this.heartbeat.stop(),this.heartbeat=new h}async getPatchUsingHTTP(e){const t=await this._fetch("GET",e,"application/json-patch+json",null,!0);return this._notifyReceive(t,e,"GET"),t}_setRemoteUrl(e){if(this.remoteUrlSet&&this.remoteUrl&&this.remoteUrl!=e){const t=["Session lost.","Server replied with a different session ID than the already set one.","Possibly a server restart happened while you were working.","Please reload the page.","Previous session ID: "+this.remoteUrl,"New session ID: "+e].join("\n");throw new r(t)}this.remoteUrlSet=!0,this.remoteUrl=new URL(e,this.remoteUrl.href)}_handleLocationHeader(e){const t=e.headers.get("x-location")||e.headers.get("location");t&&this._setRemoteUrl(t)}async _handleFailureResponse(e,t,n){var o=`An unknown network error has occurred. Raw message: ${n.message}`;console.error(n);const r=[o,"statusCode: -1","reason: Maybe you lost connection with the server","url: "+e,"HTTP method: "+t].join("\n");this._handleFatalError(new i(r,p,e,t))}async _fetch(e,n,o,r,i){const s={headers:{},method:e,credentials:"include"},a=s.headers;r&&(a["Content-Type"]="application/json-patch+json",s.body=r),o&&(a.Accept=o),this.remoteUrl&&i&&(a["X-Referer"]=this.remoteUrl.pathname),this.onSend(r,n,e);const h=c.fetch||t,p=await h(n,s);return p.json().then(e=>{if(p.status<500)return this._handleLocationHeader(p),e;throw new Error(`HTTP ${p.status} response: response body is ${JSON.stringify(e)}`)}).catch(t=>{throw this._handleFailureResponse(n,e,t),t})}}
/*!
             * https://github.com/Starcounter-Jack/JSON-Patch
             * (c) 2017 Joachim Wester
             * MIT license
             */var f,w=(f=function(e,t){return(f=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var n in t)t.hasOwnProperty(n)&&(e[n]=t[n])})(e,t)},function(e,t){function n(){this.constructor=e}f(e,t),e.prototype=null===t?Object.create(t):(n.prototype=t.prototype,new n)}),v=Object.prototype.hasOwnProperty;function y(e,t){return v.call(e,t)}function g(e){if(Array.isArray(e)){for(var t=new Array(e.length),n=0;n<t.length;n++)t[n]=""+n;return t}if(Object.keys)return Object.keys(e);t=[];for(var o in e)y(e,o)&&t.push(o);return t}function b(e){switch(typeof e){case"object":return JSON.parse(JSON.stringify(e));case"undefined":return null;default:return e}}function _(e){for(var t,n=0,o=e.length;n<o;){if(!((t=e.charCodeAt(n))>=48&&t<=57))return!1;n++}return!0}function m(e){return-1===e.indexOf("/")&&-1===e.indexOf("~")?e:e.replace(/~/g,"~0").replace(/\//g,"~1")}function O(e){return e.replace(/~1/g,"/").replace(/~0/g,"~")}function P(e,t){var n=[e];for(var o in t){var r="object"==typeof t[o]?JSON.stringify(t[o],null,2):t[o];void 0!==r&&n.push(o+": "+r)}return n.join("\n")}var E=function(e){function t(t,n,o,r,i){var s=this.constructor,a=e.call(this,P(t,{name:n,index:o,operation:r,tree:i}))||this;return a.name=n,a.index=o,a.operation=r,a.tree=i,Object.setPrototypeOf(a,s.prototype),a.message=P(t,{name:n,index:o,operation:r,tree:i}),a}return w(t,e),t}(Error),S=E,T=b,R={add:function(e,t,n){return e[t]=this.value,{newDocument:n}},remove:function(e,t,n){var o=e[t];return delete e[t],{newDocument:n,removed:o}},replace:function(e,t,n){var o=e[t];return e[t]=this.value,{newDocument:n,removed:o}},move:function(e,t,n){var o=j(n,this.path);o&&(o=b(o));var r=N(n,{op:"remove",path:this.from}).removed;return N(n,{op:"add",path:this.path,value:r}),{newDocument:n,removed:o}},copy:function(e,t,n){var o=j(n,this.from);return N(n,{op:"add",path:this.path,value:b(o)}),{newDocument:n}},test:function(e,t,n){return{newDocument:n,test:I(e[t],this.value)}},_get:function(e,t,n){return this.value=e[t],{newDocument:n}}},A={add:function(e,t,n){return _(t)?e.splice(t,0,this.value):e[t]=this.value,{newDocument:n,index:t}},remove:function(e,t,n){return{newDocument:n,removed:e.splice(t,1)[0]}},replace:function(e,t,n){var o=e[t];return e[t]=this.value,{newDocument:n,removed:o}},move:R.move,copy:R.copy,test:R.test,_get:R._get};function j(e,t){if(""==t)return e;var n={op:"_get",path:t};return N(e,n),n.value}function N(e,t,n,o,r,i){if(void 0===n&&(n=!1),void 0===o&&(o=!0),void 0===r&&(r=!0),void 0===i&&(i=0),n&&("function"==typeof n?n(t,0,e,t.path):C(t,0)),""===t.path){var s={newDocument:e};if("add"===t.op)return s.newDocument=t.value,s;if("replace"===t.op)return s.newDocument=t.value,s.removed=e,s;if("move"===t.op||"copy"===t.op)return s.newDocument=j(e,t.from),"move"===t.op&&(s.removed=e),s;if("test"===t.op){if(s.test=I(e,t.value),!1===s.test)throw new S("Test operation failed","TEST_OPERATION_FAILED",i,t,e);return s.newDocument=e,s}if("remove"===t.op)return s.removed=e,s.newDocument=null,s;if("_get"===t.op)return t.value=e,s;if(n)throw new S("Operation `op` property is not one of operations defined in RFC-6902","OPERATION_OP_INVALID",i,t,e);return s}o||(e=b(e));var a=(t.path||"").split("/"),h=e,c=1,p=a.length,l=void 0,u=void 0,d=void 0;for(d="function"==typeof n?n:C;;){if(u=a[c],r&&"__proto__"==u)throw new TypeError("JSON-Patch: modifying `__proto__` prop is banned for security reasons, if this was on purpose, please set `banPrototypeModifications` flag false and pass it to this function. More info in fast-json-patch README");if(n&&void 0===l&&(void 0===h[u]?l=a.slice(0,c).join("/"):c==p-1&&(l=t.path),void 0!==l&&d(t,0,e,l)),c++,Array.isArray(h)){if("-"===u)u=h.length;else{if(n&&!_(u))throw new S("Expected an unsigned base-10 integer value, making the new referenced value the array element with the zero-based index","OPERATION_PATH_ILLEGAL_ARRAY_INDEX",i,t,e);_(u)&&(u=~~u)}if(c>=p){if(n&&"add"===t.op&&u>h.length)throw new S("The specified index MUST NOT be greater than the number of elements in the array","OPERATION_VALUE_OUT_OF_BOUNDS",i,t,e);if(!1===(s=A[t.op].call(t,h,u,e)).test)throw new S("Test operation failed","TEST_OPERATION_FAILED",i,t,e);return s}}else if(u&&-1!=u.indexOf("~")&&(u=O(u)),c>=p){if(!1===(s=R[t.op].call(t,h,u,e)).test)throw new S("Test operation failed","TEST_OPERATION_FAILED",i,t,e);return s}h=h[u]}}function k(e,t,n,o,r){if(void 0===o&&(o=!0),void 0===r&&(r=!0),n&&!Array.isArray(t))throw new S("Patch sequence must be an array","SEQUENCE_NOT_AN_ARRAY");o||(e=b(e));for(var i=new Array(t.length),s=0,a=t.length;s<a;s++)i[s]=N(e,t[s],n,!0,r,s),e=i[s].newDocument;return i.newDocument=e,i}function C(e,t,n,o){if("object"!=typeof e||null===e||Array.isArray(e))throw new S("Operation is not an object","OPERATION_NOT_AN_OBJECT",t,e,n);if(!R[e.op])throw new S("Operation `op` property is not one of operations defined in RFC-6902","OPERATION_OP_INVALID",t,e,n);if("string"!=typeof e.path)throw new S("Operation `path` property is not a string","OPERATION_PATH_INVALID",t,e,n);if(0!==e.path.indexOf("/")&&e.path.length>0)throw new S('Operation `path` property must start with "/"',"OPERATION_PATH_INVALID",t,e,n);if(("move"===e.op||"copy"===e.op)&&"string"!=typeof e.from)throw new S("Operation `from` property is not present (applicable in `move` and `copy` operations)","OPERATION_FROM_REQUIRED",t,e,n);if(("add"===e.op||"replace"===e.op||"test"===e.op)&&void 0===e.value)throw new S("Operation `value` property is not present (applicable in `add`, `replace` and `test` operations)","OPERATION_VALUE_REQUIRED",t,e,n);if(("add"===e.op||"replace"===e.op||"test"===e.op)&&function e(t){if(void 0===t)return!0;if(t)if(Array.isArray(t)){for(var n=0,o=t.length;n<o;n++)if(e(t[n]))return!0}else if("object"==typeof t){var r=g(t),i=r.length;for(n=0;n<i;n++)if(e(t[r[n]]))return!0}return!1}(e.value))throw new S("Operation `value` property is not present (applicable in `add`, `replace` and `test` operations)","OPERATION_VALUE_CANNOT_CONTAIN_UNDEFINED",t,e,n);if(n)if("add"==e.op){var r=e.path.split("/").length,i=o.split("/").length;if(r!==i+1&&r!==i)throw new S("Cannot perform an `add` operation at the desired path","OPERATION_PATH_CANNOT_ADD",t,e,n)}else if("replace"===e.op||"remove"===e.op||"_get"===e.op){if(e.path!==o)throw new S("Cannot perform the operation at a path that does not exist","OPERATION_PATH_UNRESOLVABLE",t,e,n)}else if("move"===e.op||"copy"===e.op){var s=x([{op:"_get",path:e.from,value:void 0}],n);if(s&&"OPERATION_PATH_UNRESOLVABLE"===s.name)throw new S("Cannot perform the operation from a path that does not exist","OPERATION_FROM_UNRESOLVABLE",t,e,n)}}function x(e,t,n){try{if(!Array.isArray(e))throw new S("Patch sequence must be an array","SEQUENCE_NOT_AN_ARRAY");if(t)k(b(t),b(e),n||!0);else{n=n||C;for(var o=0;o<e.length;o++)n(e[o],o,t,void 0)}}catch(e){if(e instanceof S)return e;throw e}}function I(e,t){if(e===t)return!0;if(e&&t&&"object"==typeof e&&"object"==typeof t){var n,o,r,i=Array.isArray(e),s=Array.isArray(t);if(i&&s){if((o=e.length)!=t.length)return!1;for(n=o;0!=n--;)if(!I(e[n],t[n]))return!1;return!0}if(i!=s)return!1;var a=Object.keys(e);if((o=a.length)!==Object.keys(t).length)return!1;for(n=o;0!=n--;)if(!t.hasOwnProperty(a[n]))return!1;for(n=o;0!=n--;)if(!I(e[r=a[n]],t[r]))return!1;return!0}return e!=e&&t!=t}var M=Object.freeze({__proto__:null,JsonPatchError:S,deepClone:T,getValueByPointer:j,applyOperation:N,applyPatch:k,applyReducer:function(e,t,n){var o=N(e,t);if(!1===o.test)throw new S("Test operation failed","TEST_OPERATION_FAILED",n,t,e);return o.newDocument},validator:C,validate:x,_areEquals:I}),U=new WeakMap,L=function(e){this.observers=new Map,this.obj=e},D=function(e,t){this.callback=e,this.observer=t};
/*!
             * https://github.com/Starcounter-Jack/JSON-Patch
             * (c) 2017 Joachim Wester
             * MIT license
             */function V(e,t){void 0===t&&(t=!1);var n=U.get(e.object);J(n.value,e.object,e.patches,"",t),e.patches.length&&k(n.value,e.patches);var o=e.patches;return o.length>0&&(e.patches=[],e.callback&&e.callback(o)),o}function J(e,t,n,o,r){if(t!==e){"function"==typeof t.toJSON&&(t=t.toJSON());for(var i=g(t),s=g(e),a=!1,h=s.length-1;h>=0;h--){var c=e[l=s[h]];if(!y(t,l)||void 0===t[l]&&void 0!==c&&!1===Array.isArray(t))Array.isArray(e)===Array.isArray(t)?(r&&n.push({op:"test",path:o+"/"+m(l),value:b(c)}),n.push({op:"remove",path:o+"/"+m(l)}),a=!0):(r&&n.push({op:"test",path:o,value:e}),n.push({op:"replace",path:o,value:t}));else{var p=t[l];"object"==typeof c&&null!=c&&"object"==typeof p&&null!=p?J(c,p,n,o+"/"+m(l),r):c!==p&&(r&&n.push({op:"test",path:o+"/"+m(l),value:b(c)}),n.push({op:"replace",path:o+"/"+m(l),value:b(p)}))}}if(a||i.length!=s.length)for(h=0;h<i.length;h++){var l;y(e,l=i[h])||void 0===t[l]||n.push({op:"add",path:o+"/"+m(l),value:b(t[l])})}}}var q=Object.freeze({__proto__:null,unobserve:function(e,t){t.unobserve()},observe:function(e,t){var n,o=function(e){return U.get(e)}(e);if(o){var r=function(e,t){return e.observers.get(t)}(o,t);n=r&&r.observer}else o=new L(e),U.set(e,o);if(n)return n;if(n={},o.value=b(e),t){n.callback=t,n.next=null;var i=function(){V(n)},s=function(){clearTimeout(n.next),n.next=setTimeout(i)};"undefined"!=typeof window&&(window.addEventListener("mouseup",s),window.addEventListener("keyup",s),window.addEventListener("mousedown",s),window.addEventListener("keydown",s),window.addEventListener("change",s))}return n.patches=[],n.object=e,n.unobserve=function(){V(n),clearTimeout(n.next),function(e,t){e.observers.delete(t.callback)}(o,n),"undefined"!=typeof window&&(window.removeEventListener("mouseup",s),window.removeEventListener("keyup",s),window.removeEventListener("mousedown",s),window.removeEventListener("keydown",s),window.removeEventListener("change",s))},o.observers.set(t,new D(t,n)),n},generate:V,compare:function(e,t,n){void 0===n&&(n=!1);var o=[];return J(e,t,o,"",n),o}});Object.assign({},M,q,{JsonPatchError:E,deepClone:b,escapePathComponent:m,unescapePathComponent:O});
/*!
