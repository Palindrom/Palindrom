 ...
 * MIT license
 */
var o;!function(e){function t(e,n){switch(typeof e){case"undefined":case"boolean":case"string":case"number":return e===n;case"object":if(null===e)return null===n;if(_(e)){if(!_(n)||e.length!==n.length)return!1;for(var o=0,r=e.length;o<r;o++)if(!t(e[o],n[o]))return!1;return!0}var i=b(n),s=i.length;if(b(e).length!==s)return!1;for(var o=0;o<s;o++)if(!t(e[o],n[o]))return!1;return!0;default:return!1}}function n(e){return e.indexOf("/")===-1&&e.indexOf("~")===-1?e:e.replace(/~/g,"~0").replace(/\//g,"~1")}function o(e){for(var t=0,n=E.length;t<n;t++)if(E[t].obj===e)return E[t]}function r(e,t){for(var n=0,o=e.observers.length;n<o;n++)if(e.observers[n].callback===t)return e.observers[n].observer}function i(e,t){for(var n=0,o=e.observers.length;n<o;n++)if(e.observers[n].observer===t)return void e.observers.splice(n,1)}function s(e,t){t.unobserve()}function a(e){switch(typeof e){case"object":return JSON.parse(JSON.stringify(e));case"undefined":return null;default:return e}}function h(e,t){var n,s=[],h=o(e);if(h?n=r(h,t):(h=new P(e),E.push(h)),n)return n;if(n={},h.value=a(e),t){n.callback=t,n.next=null;var p=function(){c(n)},u=function(){clearTimeout(n.next),n.next=setTimeout(p)};"undefined"!=typeof window&&(window.addEventListener?(window.addEventListener("mouseup",u),window.addEventListener("keyup",u),window.addEventListener("mousedown",u),window.addEventListener("keydown",u),window.addEventListener("change",u)):(document.documentElement.attachEvent("onmouseup",u),document.documentElement.attachEvent("onkeyup",u),document.documentElement.attachEvent("onmousedown",u),document.documentElement.attachEvent("onkeydown",u),document.documentElement.attachEvent("onchange",u)))}return n.patches=s,n.object=e,n.unobserve=function(){c(n),clearTimeout(n.next),i(h,n),"undefined"!=typeof window&&(window.removeEventListener?(window.removeEventListener("mouseup",u),window.removeEventListener("keyup",u),window.removeEventListener("mousedown",u),window.removeEventListener("keydown",u)):(document.documentElement.detachEvent("onmouseup",u),document.documentElement.detachEvent("onkeyup",u),document.documentElement.detachEvent("onmousedown",u),document.documentElement.detachEvent("onkeydown",u)))},h.observers.push(new S(t,n)),n}function c(e){for(var t,n=0,o=E.length;n<o;n++)if(E[n].obj===e.object){t=E[n];break}p(t.value,e.object,e.patches,""),e.patches.length&&l(t.value,e.patches);var r=e.patches;return r.length>0&&(e.patches=[],e.callback&&e.callback(r)),r}function p(e,t,o,r){if(t!==e){"function"==typeof t.toJSON&&(t=t.toJSON());for(var i=b(t),s=b(e),h=!1,c=s.length-1;c>=0;c--){var u=s[c],l=e[u];if(!t.hasOwnProperty(u)||void 0===t[u]&&void 0!==l&&_(t)===!1)o.push({op:"remove",path:r+"/"+n(u)}),h=!0;else{var f=t[u];"object"==typeof l&&null!=l&&"object"==typeof f&&null!=f?p(l,f,o,r+"/"+n(u)):l!==f&&(!0,o.push({op:"replace",path:r+"/"+n(u),value:a(f)}))}}if(h||i.length!=s.length)for(var c=0;c<i.length;c++){var u=i[c];e.hasOwnProperty(u)||void 0===t[u]||o.push({op:"add",path:r+"/"+n(u),value:a(t[u])})}}}function u(e){for(var t,n=0,o=e.length;n<o;){t=e.charCodeAt(n);{if(!(t>=48&&t<=57))return!1;n++}}return!0}function l(e,t,n){for(var o,r,i=[],s=0,a=t.length;s<a;){o=t[s],s++;for(var h=o.path||"",c=h.split("/"),p=e,l=1,f=c.length,d=void 0;;){if(r=c[l],n&&void 0===d&&(void 0===p[r]?d=c.slice(0,l).join("/"):l==f-1&&(d=o.path),void 0!==d&&this.validator(o,s-1,e,d)),l++,void 0===r&&l>=f){i.push(O[o.op].call(o,p,r,e));break}if(_(p)){if("-"===r)r=p.length;else{if(n&&!u(r))throw new x("Expected an unsigned base-10 integer value, making the new referenced value the array element with the zero-based index","OPERATION_PATH_ILLEGAL_ARRAY_INDEX",s-1,o.path,o);r=parseInt(r,10)}if(l>=f){if(n&&"add"===o.op&&r>p.length)throw new x("The specified index MUST NOT be greater than the number of elements in the array","OPERATION_VALUE_OUT_OF_BOUNDS",s-1,o.path,o);i.push(w[o.op].call(o,p,r,e));break}}else if(r&&r.indexOf("~")!=-1&&(r=r.replace(/~1/g,"/").replace(/~0/g,"~")),l>=f){i.push(m[o.op].call(o,p,r,e));break}p=p[r]}}return i}function f(e,t){var n=[];return p(e,t,n,""),n}function d(e,t){function n(){this.constructor=e}for(var o in t)t.hasOwnProperty(o)&&(e[o]=t[o]);e.prototype=null===t?Object.create(t):(n.prototype=t.prototype,new n)}function v(e){if(void 0===e)return!0;if("array"==typeof e||"object"==typeof e)for(var t in e)if(v(e[t]))return!0;return!1}function y(t,n,o,r){if("object"!=typeof t||null===t||_(t))throw new x("Operation is not an object","OPERATION_NOT_AN_OBJECT",n,t,o);if(!m[t.op])throw new x("Operation `op` property is not one of operations defined in RFC-6902","OPERATION_OP_INVALID",n,t,o);if("string"!=typeof t.path)throw new x("Operation `path` property is not a string","OPERATION_PATH_INVALID",n,t,o);if(0!==t.path.indexOf("/")&&t.path.length>0)throw new x('Operation `path` property must start with "/"',"OPERATION_PATH_INVALID",n,t,o);if(("move"===t.op||"copy"===t.op)&&"string"!=typeof t.from)throw new x("Operation `from` property is not present (applicable in `move` and `copy` operations)","OPERATION_FROM_REQUIRED",n,t,o);if(("add"===t.op||"replace"===t.op||"test"===t.op)&&void 0===t.value)throw new x("Operation `value` property is not present (applicable in `add`, `replace` and `test` operations)","OPERATION_VALUE_REQUIRED",n,t,o);if(("add"===t.op||"replace"===t.op||"test"===t.op)&&v(t.value))throw new x("Operation `value` property is not present (applicable in `add`, `replace` and `test` operations)","OPERATION_VALUE_CANNOT_CONTAIN_UNDEFINED",n,t,o);if(o)if("add"==t.op){var i=t.path.split("/").length,s=r.split("/").length;if(i!==s+1&&i!==s)throw new x("Cannot perform an `add` operation at the desired path","OPERATION_PATH_CANNOT_ADD",n,t,o)}else if("replace"===t.op||"remove"===t.op||"_get"===t.op){if(t.path!==r)throw new x("Cannot perform the operation at a path that does not exist","OPERATION_PATH_UNRESOLVABLE",n,t,o)}else if("move"===t.op||"copy"===t.op){var a={op:"_get",path:t.from,value:void 0},h=e.validate([a],o);if(h&&"OPERATION_PATH_UNRESOLVABLE"===h.name)throw new x("Cannot perform the operation from a path that does not exist","OPERATION_FROM_UNRESOLVABLE",n,t,o)}}function g(e,t){try{if(!_(e))throw new x("Patch sequence must be an array","SEQUENCE_NOT_AN_ARRAY");if(t)t=JSON.parse(JSON.stringify(t)),l.call(this,t,e,!0);else for(var n=0;n<e.length;n++)this.validator(e[n],n)}catch(e){if(e instanceof x)return e;throw e}}var b=function(e){if(_(e)){for(var t=new Array(e.length),n=0;n<t.length;n++)t[n]=""+n;return t}if(Object.keys)return Object.keys(e);var t=[];for(var o in e)e.hasOwnProperty(o)&&t.push(o);return t},m={add:function(e,t){e[t]=this.value},remove:function(e,t){var n=e[t];return delete e[t],n},replace:function(e,t){var n=e[t];return e[t]=this.value,n},move:function(e,t,n){var o={op:"_get",path:this.path};l(n,[o]);var r=void 0===o.value?void 0:JSON.parse(JSON.stringify(o.value)),i={op:"_get",path:this.from};return l(n,[i]),l(n,[{op:"remove",path:this.from}]),l(n,[{op:"add",path:this.path,value:i.value}]),r},copy:function(e,t,n){var o={op:"_get",path:this.from};l(n,[o]),l(n,[{op:"add",path:this.path,value:o.value}])},test:function(e,n){return t(e[n],this.value)},_get:function(e,t){this.value=e[t]}},w={add:function(e,t){return e.splice(t,0,this.value),t},remove:function(e,t){return e.splice(t,1)[0]},replace:function(e,t){var n=e[t];return e[t]=this.value,n},move:m.move,copy:m.copy,test:m.test,_get:m._get},O={add:function(e){O.remove.call(this,e);for(var t in this.value)this.value.hasOwnProperty(t)&&(e[t]=this.value[t])},remove:function(e){var t={};for(var n in e)e.hasOwnProperty(n)&&(t[n]=e[n],m.remove.call(this,e,n));return t},replace:function(e){var t=l(e,[{op:"remove",path:this.path}]);return l(e,[{op:"add",path:this.path,value:this.value}]),t[0]},move:m.move,copy:m.copy,test:function(e){return JSON.stringify(e)===JSON.stringify(this.value)},_get:function(e){this.value=e}},E=[],P=function(){function e(e){this.observers=[],this.obj=e}return e}(),S=function(){function e(e,t){this.callback=e,this.observer=t}return e}();e.unobserve=s,e.observe=h,e.generate=c;var _;_=Array.isArray?Array.isArray:function(e){return e.push&&"number"==typeof e.length},e.apply=l,e.compare=f;var x=function(e){function t(t,n,o,r,i){e.call(this,t),this.message=t,this.name=n,this.index=o,this.operation=r,this.tree=i}return d(t,e),t}(Error);e.JsonPatchError=x,e.validator=y,e.validate=g}(o||(o={}));var t,r;t.apply=o.apply,t.observe=o.observe,t.unobserve=o.unobserve,t.generate=o.generate,t.compare=o.compare,t.validate=o.validate,t.validator=o.validator,t.JsonPatchError=o.JsonPatchError,Object.defineProperty(t,"__esModule",{value:!0}),t.default=o,r&&(t=void 0)},function(e,t,n){if(void 0===o)var o=n(0).JSONPatchQueue;var r=function(e,t,n,r){o.call(this,t,n,r),this.transform=e,this.pending=[]};r.prototype=Object.create(o.prototype),r.prototype.constructor=r,r.prototype.ackLocalVersion=0,r.prototype.send=function(e){var t=e.slice(0);t.unshift({op:"test",path:this.remotePath,value:this.remoteVersion});var n=o.prototype.send.call(this,t);return this.pending.push(n),n},r.prototype.receive=function(e,t,n){var r=n||this.apply,i=this;return o.prototype.receive.call(this,e,t,function(e,t){var n=t.slice(0),o=n.shift().value,s=o-i.ackLocalVersion;i.ackLocalVersion=o,i.pending.splice(0,s),i.pending.length&&(n=i.transform(n,i.pending)),r(e,n)})},r.prototype.reset=function(e,t){this.ackLocalVersion=o.getPropertyByJsonPointer(t,this.localPath),this.pending=[],o.prototype.reset.call(this,e,t)},e.exports=r,e.exports.default=r,e.exports.__esModule=!0},function(e,t,n){/*!
